    ...
    <>
      ...
      <div className="container">
        <div className="grid_categorias">
          <Link
            className="grid_categorias_hijo  grid_categorias_hijo-1"
            to={"/category/Abrigos"}
          >
          ...
          <Link
            ...
            className="grid_categorias_hijo grid_categorias_hijo-2"
          >
          ...
          <Link
            to={"/category/Remeras"}
            className="grid_categorias_hijo grid_categorias_hijo-3"
          >
